...
const BookingForm = () => {
  ...
  return (
    <div className="bg-[#F3F4F6] text-gray-800 min-h-screen w-full">
      <main className="">
        <div className="  flex items-center justify-between w-full px-4 md:px-8 py-5 border-b bg-white">
        ...
        <section className="flex flex-col lg:flex-row items-start justify-center px-4 md:px-8 py-9 gap-8 w-full">
          <form
            className="w-full lg:w-[60%] bg-white shadow-xl rounded-xl p-6 md:p-8 space-y-6"
          ...
          >
            ...
            <div className="space-y-2 pt-4">
              ...
              <div className="flex items-start">
                ...
                >
                  I have read and accept the rental information, the privacy and
                  I acknowledge that I am booking a prepaid rate, where the
                  total reservation price is immediately chargers to the payment
                  method I provided.
                </label>
              </div>
            </div>
          ...
          {/* Right Summary Panel */}
          <div className="w-full lg:w-[40%] mt-8 lg:mt-0 sticky top-8">
            {" "}
            {/* Sticky for better UX on scroll */}
            {selectedCar ? (
              <div className="bg-[#f0f9ff] p-5 md:p-6 rounded-xl shadow-xl border border-blue-200 space-y-5">
                <div className="flex flex-col sm:flex-row gap-4 items-center sm:items-start">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      License: {selectedCar.numberPlate || "BA 1 JA 2023"}
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-[#f0f9ff] p-6 rounded-xl shadow-xl border border-blue-200 text-center">
