...
const RatingCard = ({ rating }) => {
  const ratingStars = Array.from({ length: 5 }, (_, index) => index < rating.ratingValue);

  return (
    <div className="relative bg-[#F5F5F5] shadow-lg rounded-3xl flex items-center p-6 w-full max-w-[400px] sm:max-w-[325px] h-[160px]">
      <div className="absolute left-[-33px] z-10 top-[-10px] border-subheading border-[2px] rounded-full overflow-hidden h-[186px] w-[110px]"></div>
